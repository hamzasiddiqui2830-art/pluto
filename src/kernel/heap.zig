...
pub const FreeListAllocator = struct {
    ...
    pub fn alloc(self: *Self, size: usize, alignment: u29, size_alignment: u29, ret_addr: usize) Allocator.Error![]u8 {
        ...
        if (alloc_to) |x| {
            ...
            return @ptrFromInt([*]u8, @intFromPtr(header))[0..std.mem.alignAllocLen(size, size, size_alignment)];
        }
    ...
    test "init" {
        ...
        var free_list = &(try FreeListAllocator.init(@intFromPtr(region.ptr), size));

        var header = @ptrFromInt(*FreeListAllocator.Header, @intFromPtr(region.ptr));
    ...
    test "alloc" {
        ...
        var header = @ptrFromInt(*Header, start + 64);
        ...
        header = @ptrFromInt(*Header, alloc1_end);
        ...
        const second_header = @ptrFromInt(*Header, alloc2_end);
        ...
        const header2 = @ptrFromInt(*Header, alloc3_end);
        ...
        const header3 = @ptrFromInt(*Header, alloc4_end);
    ...
    test "free" {
        ...
        const free_node3 = @ptrFromInt(*Header, @intFromPtr(alloc2.ptr) + alloc2.len);
        ...
        const free_node0 = @ptrFromInt(*Header, start);
    ...
    test "resize" {
        ...
        var header = @ptrFromInt(*Header, @intFromPtr(alloc1.ptr) + 512);
        ...
        header = @ptrFromInt(*Header, @intFromPtr(alloc1.ptr) + 128);
